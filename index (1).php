...
<head>
    ...
    <style>
        ...
        .buttons-group { display: flex; gap: 8px; }
        .btn-cart {
        ...
        .btn-cart:hover { background: rgba(255,0,60,0.15); transform: scale(1.05); }
        ...
        .footer-action { display: flex; justify-content: space-between; align-items: center; border-top: 1px solid #1a1a1a; padding-top: 15px; margin-top: auto; }
        .price { color: #ff003c; font-size: 20px; font-weight: 700; }
        .btn-buy { background: transparent; color: #fff; border: 1px solid #ff003c; padding: 6px 18px; font-size: 11px; font-weight: 700; text-transform: uppercase; cursor: pointer; transition: all 0.3s; }
        .btn-buy:hover { background: #ff003c; box-shadow: 0 0 10px rgba(255,0,60,0.5); }
        .hero { background: linear-gradient(180deg, rgba(14,2,6,0.8) 0%, rgba(0,0,0,0.95) 100%), url('images/hero-bg.jpg') no-repeat center center/cover; height: 450px; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; padding: 0 20px; border-bottom: 1px solid #1a1a1a; }
        .hero h1 { font-family: 'Orbitron', sans-serif; font-size: 48px; font-weight: 900; letter-spacing: 3px; margin-bottom: 15px; text-shadow: 0 0 20px rgba(255,0,60,0.6); }
        ...
        .feature-box h4 { font-size: 15px; font-weight: 700; margin-bottom: 8px; color: #fff; }
        ...
        <div class="products-grid">
            <?php if ($result_produk && $result_produk->num_rows > 0): ?>
                <?php while($row = $result_produk->fetch_assoc()): 
                    // PERBAIKAN: Menggunakan key 'nama' sesuai nama kolom asli di tabel database 'data produk'
                    $id = $row['id_produk'] ?? 0;
                    ...
                    <div class="product-info">
                        ...
                        <div class="footer-action">
                            ...
                            <div class="buttons-group">
                                ...
                                <button class="btn-buy" onclick="cartAction(<?php echo $id; ?>, '<?php echo addslashes($nama); ?>', <?php echo $harga; ?>, 'buy')">BUY</button>
                            </div>
                        </div>
                    </div>
                </div>
